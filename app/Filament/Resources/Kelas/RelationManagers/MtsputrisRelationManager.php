...
class MtsputrisRelationManager extends RelationManager
{
    protected static string $relationship = 'mtsputris';
        ...
        return $table
                        ...
                        Action::make('attachStudent')
                            ...
                            ->form([
                                Select::make('siswa_id')
                                    ...
                                    ->preload()
                                    ->options(
                                        \App\Models\Mtsputri::whereNull('kelas_id')
                                            ->orderBy('nama')
                                            ->pluck('nama', 'id')
                                    )
                                    ->required(),
                            ...
                            ->action(function (array $data, RelationManager $livewire) {
                                ...
                                // update siswa
                                \App\Models\Mtsputri::find($data['siswa_id'])
            ...
            ->recordActions([
                ViewAction::make('view')
                    ->label('Lihat')
                    ->icon('heroicon-o-eye')
                    ->url(fn ($record) => route('filament.admin.resources.mtsputris.edit', $record))
                    ->openUrlInNewTab(),
