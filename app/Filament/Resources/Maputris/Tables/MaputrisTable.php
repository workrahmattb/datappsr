...
namespace App\Filament\Resources\Maputris\Tables;
        ...
        return $table
            ...
            ->actions([
                ...
                ->action(function ($record) {
                    $pdf = Pdf::loadView('pdf.maputri', [
                        'record' => $record
                    ]);

                    return response()->streamDownload(function () use ($pdf) {
                        echo $pdf->output();
                    }, 'maputri-' . $record->id . '.pdf');
                }),
            ...
            ->headerActions([
                Action::make('export')
                    ...
                    ->action(function (array $data) {
                        ...
                        // Nama file final
                        $file = "maputri-{$tahunFile}-" . now()->format('YmdHis') . '.xlsx';

                        // Ambil data berdasarkan tahun ajaran
                        $rows = Maputri::where('tahun_ajaran', $tahunAjaran)->get();
