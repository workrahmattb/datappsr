...
class MtsputraController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json([
            'status' => true,
            'message' => 'Data Mts Putra berhasil diambil',
            'data' => $data
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $mtsputra = Mtsputra::create($request->all());

            return response()->json([
                'status' => true,
                'message' => 'Data Mts Putra berhasil ditambahkan',
                'data' => $mtsputra
            ], 201);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            $mtsputra->update($request->all());

            return response()->json([
                'status' => true,
                'message' => 'Data Mts Putra berhasil diupdate',
                'data' => $mtsputra->fresh()
            ]);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return response()->json([
                'status' => true,
                'message' => 'Data Mts Putra berhasil dihapus'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
