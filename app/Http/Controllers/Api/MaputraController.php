...
class MaputraController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json([
            'status' => true,
            'message' => 'Data MA Putra berhasil diambil',
            'data' => $data
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $maputra = Maputra::create($request->all());

            return response()->json([
                'status' => true,
                'message' => 'Data MA Putra berhasil ditambahkan',
                'data' => $maputra
            ], 201);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            $maputra->update($request->all());

            return response()->json([
                'status' => true,
                'message' => 'Data MA Putra berhasil diupdate',
                'data' => $maputra->fresh()
            ]);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return response()->json([
                'status' => true,
                'message' => 'Data MA Putra berhasil dihapus'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
