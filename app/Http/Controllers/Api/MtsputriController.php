...
class MtsputriController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json([
            'status' => true,
            'message' => 'Data Mts Putri berhasil diambil',
            'data' => $data
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $mtsputri = Mtsputri::create($request->all());

            return response()->json([
                'status' => true,
                'message' => 'Data Mts Putri berhasil ditambahkan',
                'data' => $mtsputri
            ], 201);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            $mtsputri->update($request->all());

            return response()->json([
                'status' => true,
                'message' => 'Data Mts Putri berhasil diupdate',
                'data' => $mtsputri->fresh()
            ]);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return response()->json([
                'status' => true,
                'message' => 'Data Mts Putri berhasil dihapus'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
