@php
    if(isset($mtsputra)) { $student = $mtsputra; $title = 'Siswa MTs Putra'; $routePrefix = 'admin.mtsputras'; }
    elseif(isset($mtsputri)) { $student = $mtsputri; $title = 'Siswi MTs Putri'; $routePrefix = 'admin.mtsputris'; }
    elseif(isset($maputra)) { $student = $maputra; $title = 'Siswa MA Putra'; $routePrefix = 'admin.maputras'; }
    elseif(isset($maputri)) { $student = $maputri; $title = 'Siswi MA Putri'; $routePrefix = 'admin.maputris'; }
@endphp
