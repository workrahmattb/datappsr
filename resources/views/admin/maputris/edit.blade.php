        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $maputri->tanggal_lahir ? \Carbon\Carbon::parse($maputri->tanggal_lahir)->format('Y-m-d') : '') }}" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
