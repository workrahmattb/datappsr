...
@section('page-title', 'Edit Siswi MA Putri')
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nama" value="{{ old('nama', $maputri->nama) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    @error('nama')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">NIK</label>
                    <input type="text" name="nik" maxlength="16" value="{{ old('nik', $maputri->nik) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    @error('nik')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Tempat Lahir</label>
                    <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $maputri->tempat_lahir) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    @error('tempat_lahir')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Tanggal Lahir</label>
                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $maputri->tanggal_lahir ? \Carbon\Carbon::parse($maputri->tanggal_lahir)->format('Y-m-d') : '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="nis" value="{{ old('nis', $maputri->nis) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    @error('nis')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Nomor KK</label>
                    <input type="text" name="kk" value="{{ old('kk', $maputri->kk) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="nama_kk" value="{{ old('nama_kk', $maputri->nama_kk) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="anak_ke" value="{{ old('anak_ke', $maputri->anak_ke) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="jumlah_saudara" value="{{ old('jumlah_saudara', $maputri->jumlah_saudara) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    @error('jumlah_saudara')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Tahun Ajaran</label>
                    <input type="text" name="tahun_ajaran" value="{{ old('tahun_ajaran', $maputri->tahun_ajaran) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    @error('tahun_ajaran')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Tanggal Masuk</label>
                    <input type="date" name="tgl_masuk" value="{{ old('tgl_masuk', $maputri->tgl_masuk ? \Carbon\Carbon::parse($maputri->tgl_masuk)->format('Y-m-d') : '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="kks" value="{{ old('kks', $maputri->kks) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="pkh" value="{{ old('pkh', $maputri->pkh) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="kip" value="{{ old('kip', $maputri->kip) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="border-t pt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="jenjang_pendidikan_sebelumnya" value="{{ old('jenjang_pendidikan_sebelumnya', $maputri->jenjang_pendidikan_sebelumnya) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="status_sekolah_sebelumnya" value="{{ old('status_sekolah_sebelumnya', $maputri->status_sekolah_sebelumnya) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="nama_sekolah_sebelumnya" value="{{ old('nama_sekolah_sebelumnya', $maputri->nama_sekolah_sebelumnya) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="npsn_sekolah_sebelumnya" value="{{ old('npsn_sekolah_sebelumnya', $maputri->npsn_sekolah_sebelumnya) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="alamat_sekolah_sebelumnya" value="{{ old('alamat_sekolah_sebelumnya', $maputri->alamat_sekolah_sebelumnya) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="kecamatan_sekolah_sebelumnya" value="{{ old('kecamatan_sekolah_sebelumnya', $maputri->kecamatan_sekolah_sebelumnya) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="kabupaten_sekolah_sebelumnya" value="{{ old('kabupaten_sekolah_sebelumnya', $maputri->kabupaten_sekolah_sebelumnya) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="provinsi_sekolah_sebelumnya" value="{{ old('provinsi_sekolah_sebelumnya', $maputri->provinsi_sekolah_sebelumnya) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="border-t pt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nik_ayah" maxlength="16" value="{{ old('nik_ayah', $maputri->nik_ayah) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="tempat_lahir_ayah" value="{{ old('tempat_lahir_ayah', $maputri->tempat_lahir_ayah) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir_ayah" value="{{ old('tanggal_lahir_ayah', $maputri->tanggal_lahir_ayah ? \Carbon\Carbon::parse($maputri->tanggal_lahir_ayah)->format('Y-m-d') : '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="status_ayah" value="{{ old('status_ayah', $maputri->status_ayah) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <select name="pendidikan_ayah" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        @foreach(['SD/Sederajat','SMP/Sederajat','SMA/Sederajat','D1','D2','D3','D4/S1','S2','S3','Tidak Bersekolah','Lainnya'] as $opt)
                            <option value="{{ $opt }}" {{ old('pendidikan_ayah', $maputri->pendidikan_ayah) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="pekerjaan_ayah" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        @foreach(['Tidak Bekerja','Pensiunan','PNS','TNI/Polisi','Guru/Dosen','Pegawai Swasta','Wiraswasta','Pengacara/Jaksa/Hakim/Notaris','Seniman/Pelukis/Artis/Sejenis','Dokter/Bidan/Perawat','Pilot/Pramugara','Pedagang','Petani/Peternak','Nelayan','Buruh (Tani/Pabrik/Bangunan)','Sopir/Masinis/Kondektur','Politikus','Lainnya'] as $opt)
                            <option value="{{ $opt }}" {{ old('pekerjaan_ayah', $maputri->pekerjaan_ayah) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="penghasilan_ayah" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        @foreach(['Tidak Ada','Dibawah 800.000','800.001 - 1.200.000','1.200.001 - 1.800.000','1.800.001 - 2.500.000','2.500.001 - 3.500.000','3.500.001 - 4.800.000','4.800.001 - 6.500.000','6.500.001 - 10.000.000','10.000.001 - 20.000.000','Diatas 20.000.001'] as $opt)
                            <option value="{{ $opt }}" {{ old('penghasilan_ayah', $maputri->penghasilan_ayah) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                        @endforeach
                    </select>
        ...
        <div class="border-t pt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nik_ibu" maxlength="16" value="{{ old('nik_ibu', $maputri->nik_ibu) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="tempat_lahir_ibu" value="{{ old('tempat_lahir_ibu', $maputri->tempat_lahir_ibu) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir_ibu" value="{{ old('tanggal_lahir_ibu', $maputri->tanggal_lahir_ibu ? \Carbon\Carbon::parse($maputri->tanggal_lahir_ibu)->format('Y-m-d') : '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="status_ibu" value="{{ old('status_ibu', $maputri->status_ibu) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <select name="pendidikan_ibu" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        <option value="">-- Pilih Pendidikan --</option>
                        @foreach(['SD/Sederajat','SMP/Sederajat','SMA/Sederajat','D1','D2','D3','D4/S1','S2','S3','Tidak Bersekolah','Lainnya'] as $opt)
                            <option value="{{ $opt }}" {{ old('pendidikan_ibu', $maputri->pendidikan_ibu) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="pekerjaan_ibu" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        <option value="">-- Pilih Pekerjaan --</option>
                        @foreach(['Tidak Bekerja','Pensiunan','PNS','TNI/Polisi','Guru/Dosen','Pegawai Swasta','Wiraswasta','Pengacara/Jaksa/Hakim/Notaris','Seniman/Pelukis/Artis/Sejenis','Dokter/Bidan/Perawat','Pilot/Pramugara','Pedagang','Petani/Peternak','Nelayan','Buruh (Tani/Pabrik/Bangunan)','Sopir/Masinis/Kondektur','Politikus','Lainnya'] as $opt)
                            <option value="{{ $opt }}" {{ old('pekerjaan_ibu', $maputri->pekerjaan_ibu) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="penghasilan_ibu" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        <option value="">-- Pilih Penghasilan --</option>
                        @foreach(['Tidak Ada','Dibawah 800.000','800.001 - 1.200.000','1.200.001 - 1.800.000','1.800.001 - 2.500.000','2.500.001 - 3.500.000','3.500.001 - 4.800.000','4.800.001 - 6.500.000','6.500.001 - 10.000.000','10.000.001 - 20.000.000','Diatas 20.000.001'] as $opt)
                            <option value="{{ $opt }}" {{ old('penghasilan_ibu', $maputri->penghasilan_ibu) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                        @endforeach
                    </select>
        ...
        <div class="border-t pt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="status_milik" value="{{ old('status_milik', $maputri->status_milik) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="alamat_rumah_tinggal" value="{{ old('alamat_rumah_tinggal', $maputri->alamat_rumah_tinggal) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="rt" value="{{ old('rt', $maputri->rt) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="rw" value="{{ old('rw', $maputri->rw) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="desa" value="{{ old('desa', $maputri->desa) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    @error('desa')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Kecamatan</label>
                    <input type="text" name="kecamatan" value="{{ old('kecamatan', $maputri->kecamatan) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="kabupaten" value="{{ old('kabupaten', $maputri->kabupaten) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    @error('kabupaten')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Provinsi</label>
                    <input type="text" name="provinsi" value="{{ old('provinsi', $maputri->provinsi) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    @error('provinsi')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Kode Pos</label>
                    <input type="text" name="kode_pos" value="{{ old('kode_pos', $maputri->kode_pos) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="border-t pt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nik_wali" value="{{ old('nik_wali', $maputri->nik_wali) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="nama_wali" value="{{ old('nama_wali', $maputri->nama_wali) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="tempat_lahir_wali" value="{{ old('tempat_lahir_wali', $maputri->tempat_lahir_wali) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir_wali" value="{{ old('tanggal_lahir_wali', $maputri->tanggal_lahir_wali ? \Carbon\Carbon::parse($maputri->tanggal_lahir_wali)->format('Y-m-d') : '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="no_hp_wali" value="{{ old('no_hp_wali', $maputri->no_hp_wali) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="pendidikan_wali" value="{{ old('pendidikan_wali', $maputri->pendidikan_wali) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="pekerjaan_wali" value="{{ old('pekerjaan_wali', $maputri->pekerjaan_wali) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="penghasilan_wali" value="{{ old('penghasilan_wali', $maputri->penghasilan_wali) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
